            ...
            for(let i = 0; i < basket.length; i++){
                ...
                if(isDeliveryProduct){
                    ...
                    for(let w = 0; w < basket[i].product.user.cityWay.length; w++){
                        graph[basket[i].product.user.cityWay[w].city1.name][basket[i].product.user.cityWay[w].city2.name] = basket[i].product.user.cityWay[w].length;
                        graph[basket[i].product.user.cityWay[w].city2.name][basket[i].product.user.cityWay[w].city1.name] = basket[i].product.user.cityWay[w].length;
                    }
